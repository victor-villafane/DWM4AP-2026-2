    ...
    <table class="mt-3 table table-striped" >
        ...
        lista.forEach( item => html+= `
            <tr>
                ...
                <td>${item.city}</td>
                <td>
                    <a class="btn btn-primary" href='/paises/${item.id}'>Ver</a> 
                    <a class="btn btn-warning" href='/paises/editar/${item.id}'>Editar</a>
                    <a class="btn btn-danger" href='/paises/eliminar/${item.id}'>Eliminar</a>
                </td>
            </tr>
        ` )
    html +=    `</tbody>
